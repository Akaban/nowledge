  ...
  return (
    <Formik
      initialValues={
        highlight
          ? {
              notes: highlight.comment.notes,
              actionNotes: highlight.comment.actionNotes,
            }
          : { notes: [], actionNotes: [] }
      }
      onSubmit={(values, { setErrors }) => {
        if (dirtyNotes)
          setErrors({
            notes: "Input field is not empty (did you forget to press enter?)",
          });
      ...
      {({ handleSubmit, setFieldValue, values, errors }) => {
        return (
          <div className="tip-container">
            ...
            <small>Click out of the window to cancel.</small>
            <br />
            <small>
              You can leave the notes empty, we will just store the quote.
            </small>
            <br />
            <small>
              To add a new note item type in the input field and press enter.
            </small>
            <blockquote className="tip-quote">
              {content ? content.text : highlight.content.text}
            </blockquote>
            <Form
              className="ui form"
              onSubmit={(event) => {
            ...
            >
              <div>
                ...
                <GKeepList
                  ...
                  externalSetState={(s) => setFieldValue("notes", s.items)}
                ...
                <Button
                  ...
                  disabled={
                    highlight &&
                    _.isEqual(values.notes, highlight.comment.notes)
                  }
                  positive
                  content="Save"
                />
